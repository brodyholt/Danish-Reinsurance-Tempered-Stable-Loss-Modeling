...
Severity loss modeling involves a delicate balance. Lighter-tailed models underrepresent large losses, while heavier-tailed models often introduce complications such as the possibility of infinite moments, which can render important quantities (TVaR, LEV, aggregate loss moments) mathematically undefined. 
